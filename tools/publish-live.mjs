...
async function main() {
  ...
  sign(packPath);
  console.log('âœ“ rules/rules.json  v' + src.version);
  ...
  if (existsSync(patchFile)) {
    ...
    console.log('âœ“ patch/patch.js    v' + (meta.version || src.version));
  } else {
    console.log('Â· no patch/patch.js (code patch channel idle)');
  }
